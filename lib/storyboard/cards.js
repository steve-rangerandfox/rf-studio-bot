...
export function buildUploadPromptCard() {
  ...
  return {
    ...
    body: [
      ...
      {
        type: "TextBlock",
        text: "Upload a script file or paste your script text below. I'll parse it into scenes and provision your storyboard across Boords, ElevenLabs, Figma, and FigJam.",
        wrap: true,
        spacing: "Small",
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            type: "Input.Toggle",
            id: "createFigmaAssets",
            title: "Also create Figma script layout and FigJam board",
            value: "true",
            valueOn: "true",
            valueOff: "false",
            spacing: "Medium",
    ...
    body: [
      ...
      },
      {
        ...
        facts: [
          ...
          { title: "ElevenLabs Studio", value: statuses.elevenlabs || "Pending" },
          { title: "Figma Script Layout", value: statuses.figma || "Pending" },
          { title: "FigJam Board", value: statuses.figjam || "Pending" },
        ],
      },
      {
        type: "TextBlock",
...
export function buildSummaryCard(result) {
  ...
  serviceLinks.push({
    title: "Figma Script Layout",
    value: result.figmaFileUrl
      ? result.figmaFileUrl.startsWith("figma://")
        ? "Prepared (manual import needed)"
        : `[Open in Figma](${result.figmaFileUrl})`
      : getErrorForService("Figma", result.errors),
  });

  serviceLinks.push({
    title: "FigJam Board",
    value: result.figjamFileUrl
      ? result.figjamFileUrl.startsWith("figjam://")
        ? "Prepared (plugin import needed)"
        : `[Open in FigJam](${result.figjamFileUrl})`
      : getErrorForService("FigJam", result.errors),
  });

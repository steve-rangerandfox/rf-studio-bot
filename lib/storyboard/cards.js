...
/**
 * Builds the upload prompt card for storyboard creation.
 */
export function buildUploadPromptCard() {
  return {
    ...
    body: [
      ...
      {
        type: "TextBlock",
        text: "Upload a script file or paste your script text below. I'll parse it into scenes and create your Boords storyboard.",
        wrap: true,
        spacing: "Small",
      },
      {

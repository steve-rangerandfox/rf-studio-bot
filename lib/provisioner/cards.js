...
const SERVICE_ROWS = [
  ...
  { key: "figma", displayName: "FigJam", emoji: "\ud83d\udcdd" },
        ...
        columns: [
          ...
          },
          {
            ...
            items: [
              ...
              { type: "Input.Toggle", id: "svc_figma", title: "\ud83d\udcdd FigJam", value: "true", valueOn: "true", valueOff: "false" },
...
export function buildSummaryCard(projectName, clientName, results, selectedServices) {
  ...
  const body = [
    ...
    },
    {
      type: "FactSet",
      facts: [
        { title: "Services", value: `${successCount} of 8 services provisioned` },
      ],
      spacing: "Small",
    },
    {

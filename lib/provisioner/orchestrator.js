...
const ALL_SERVICES = [
  "dropbox", "frameio", "canva", "onedrive", "clockify", "notion", "teams",
];
...
export async function runOrchestrator(env, ctx, onProgress) {
  ...
  // -- Phase 1: Parallel provisioning (5 services) --
  ...
  const keys = ["dropbox", "frameio", "canva", "onedrive", "clockify"];
  const names = ["Dropbox", "FrameIo", "Canva", "OneDrive", "Clockify"];
